...
Below code is a slightly modofied code form the above.
*/
...
class Pterodactyl
{
    ...
    public static function client()
    {
        return Http::withHeaders([
            'Authorization' => 'Bearer ' . Setting::getSetting('PterodactylAPIKey'),
            'Content-type' => 'application/json',
            'Accept' => 'Application/vnd.pterodactyl.v1+json',
        ])->baseUrl(Setting::getSetting('PterodactylURL') . '/api');
    }
    ...
    {
        return Setting::getSetting('PterodactylURL') . $route;
    }
